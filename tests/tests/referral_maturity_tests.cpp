...
BOOST_AUTO_TEST_CASE( balances_test )
{
   ...
   try {
      ...
      std::vector<account_test_in> test_accounts = {
            account_test_in("nathan", "committee-account", leaf_info(account_id_type(), 100000,2,200000/2,0,2,400000/2,0,100000/2)),
            account_test_in("ref11", "nathan", leaf_info(account_id_type(), 100000,0,50000/2,0,0,100000/2,0,100000/2)),
            account_test_in("ref12", "nathan", leaf_info(account_id_type(), 100000,0,50000/2,0,0,100000/2,0,100000/2)),
...
BOOST_AUTO_TEST_CASE( level_a_test )
{
   ...
   try {
      std::vector<account_test_in> test_accounts = {
            ...
            account_test_in("nathan1", "committee-account", leaf_info(account_id_type(), 200000,4,450000/2,0,4,450000/2,0,200000/2)),
            account_test_in("nathan3", "committee-account", leaf_info(account_id_type(), 200000,5,500000/2,0,5,500000/2,0.25,200000/2)),
            account_test_in("nathan4", "committee-account", leaf_info(account_id_type(), 100000,5,500000/2,0,5,500000/2,0,100000/2))
      };
      ...
      std::list<referral_info> ops_info_expected = {
            referral_info(accounts_map["nathan3"].id, 125000/2 * 0.0065, ""),
      };
...
BOOST_AUTO_TEST_CASE( a_referrals_mandatory_test )
{
   ...
   try {
      std::vector<account_test_in> test_accounts = {
            account_test_in("nathan", "committee-account", leaf_info(account_id_type(), 100000,4,400000/2,0,4,400000/2,0,100000/2)),
            account_test_in("nathan1", "committee-account", leaf_info(account_id_type(), 200000,4,450000/2,0,4,450000/2,0,200000/2)),
            account_test_in("nathan3", "committee-account", leaf_info(account_id_type(), 200000,5,300000/2,0,5,300000/2,0.25,200000/2)),
            account_test_in("nathan4", "committee-account", leaf_info(account_id_type(), 100000,5,500000/2,0,5,500000/2,0,100000/2))
      };
      ...
      std::list<referral_info> ops_info_expected = {
            referral_info(accounts_map["nathan3"].id, 75000/2 * 0.0065, ""),
      };
      std::list<referral_info> ops_info = result.scan();
...
BOOST_AUTO_TEST_CASE( level_b_test )
{
   ...
   try {
      std::vector<account_test_in> test_accounts = {
            ...
            account_test_in("nathan1", "committee-account", leaf_info(account_id_type(), 500000,5,500000/2,24,29,2900000/2,0.25,500000/2)),
            ...
            account_test_in("nathan4", "committee-account", leaf_info(account_id_type(), 500000,5,500000/2,24,29,2950000/2,0.25,500000/2)),
            account_test_in("nathan5", "committee-account", leaf_info(account_id_type(), 500000,4,450000/2,25,29,2950000/2,0,500000/2)),
            account_test_in("nathan6", "committee-account", leaf_info(account_id_type(), 500000,4,450000/2,24,28,2900000/2,0,500000/2)),
            account_test_in("nathan7", "committee-account", leaf_info(account_id_type(), 500000,5,500000/2,25,30,3000000/2,0.2,500000/2))
      };
      ...
      std::list<referral_info> ops_info_expected = {
            referral_info(accounts_map["nathan1"].id, 125000/2 * 0.0065, ""),
            referral_info(accounts_map["nathan4"].id, 125000/2 * 0.0065, ""),
            referral_info(accounts_map["nathan7"].id, 600000/2 * 0.0065, ""),
      };
      std::list<referral_info> ops_info = result.scan();
...
BOOST_AUTO_TEST_CASE( level_c_test )
{
   ...
   try {
      std::vector<account_test_in> test_accounts = {
            account_test_in("nathan", "committee-account", leaf_info(account_id_type(), 1000000,5,500000/2,25,125,12500000/2,0.15,1000000/2)),
            account_test_in("nathan1", "committee-account", leaf_info(account_id_type(), 900000,5,500000/2,25,125,12500000/2,0,900000/2)),
            account_test_in("nathan2", "committee-account", leaf_info(account_id_type(), 1000000,4,400000/2,25,124,12400000/2,0,1000000/2)),
            account_test_in("nathan3", "committee-account", leaf_info(account_id_type(), 900000,5,500000/2,25,124,12400000/2,0.20,900000/2)),
            account_test_in("nathan4", "committee-account", leaf_info(account_id_type(), 1000000,5,500000/2,25,124,12450000/2,0.20,1000000/2)),
      };
      ...
      std::list<referral_info> ops_info_expected = {
            referral_info(accounts_map["nathan"].id, 1875000/2 * 0.0065, ""),
            referral_info(accounts_map["nathan3"].id, 2480000/2 * 0.0065, ""),
            referral_info(accounts_map["nathan4"].id, 2490000/2 * 0.0065, ""),
      };
      std::list<referral_info> ops_info = result.scan();
...
BOOST_AUTO_TEST_CASE( level_d_test )
{
   ...
   try {
      std::vector<account_test_in> test_accounts = {
            account_test_in("nathan", "committee-account", leaf_info(account_id_type(), 2000000,5,500000/2,25,625,62500000/2,0.10,2000000/2)),
            account_test_in("nathan1", "committee-account", leaf_info(account_id_type(), 1000000,5,500000/2,25,625,62500000/2,0,1000000/2)),
      };
      ...
      std::list<referral_info> ops_info_expected = {
            referral_info(accounts_map["nathan"].id, 6250000/2 * 0.0065, ""),
      };
      std::list<referral_info> ops_info = result.scan();
...
BOOST_AUTO_TEST_CASE( level_e_test )
{
   ...
   try {
      std::vector<account_test_in> test_accounts = {
            account_test_in("nathan", "committee-account", leaf_info(account_id_type(), 3000000,5,500000/2,25,3125,312500000/2,0.05,3000000/2)),
            account_test_in("nathan1", "committee-account", leaf_info(account_id_type(), 2000000,5,500000/2,25,3125,312500000/2,0,2000000/2)),
      };
      ...
      std::list<referral_info> ops_info_expected = {
            referral_info(accounts_map["nathan"].id, 15625000/2 * 0.0065, ""),
      };
      std::list<referral_info> ops_info = result.scan();
...
BOOST_AUTO_TEST_CASE( e_referrals_mandatory_test )
{
   ...
   try {
      std::vector<account_test_in> test_accounts = {
            account_test_in("nathan", "committee-account", leaf_info(account_id_type(), 2000000,5,500000/2,25,625,60000000/2,0.10,2000000/2)),
            account_test_in("nathan1", "committee-account", leaf_info(account_id_type(), 2000000,5,500000/2,25,625,62500000/2,0,0), false),
      };
      ...
      std::list<referral_info> ops_info_expected = {
            referral_info(accounts_map["nathan"].id, 6000000/2 * 0.0065, ""),
      };
      std::list<referral_info> ops_info = result.scan();
